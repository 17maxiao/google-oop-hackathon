...
const UserPlanPage = ({ onDataChange }) => {
  ...
  useEffect(() => {
    // Simulate loading
    setTimeout(() => {
      const plan = demoDataManager.getCurrentUserPlan();
      setUserPlan(plan);

      const summary = demoDataManager.getWeekSummary();
  ...
  const handleSuggestionStatusChange = (suggestionId, status, notes) => {
    ...
    // Update data manager
    demoDataManager.updateActivity(userPlan.id, suggestionId, status, notes);
    ...
    // Update week summary
    const updatedSummary = demoDataManager.getWeekSummary();
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {weekSummary && weekSummary.summary && (
          <div style={{
            backgroundColor: theme.colors.surface,
            borderRadius: theme.borderRadius.large,
            padding: theme.spacing.xl,
